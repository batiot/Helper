...
public class ScreenGrabber {
    ...
    public @Nullable Bitmap grabScreen() {
        ...
        try {
            ...
            Log.e("ScreenGrabber","Error thrown in grabScreen() - acquireLatestImage()",exception);
        ...
        if (image != null) {
            ...
            try {
                ...
                Log.e("ScreenGrabber","Exception thrown in grabScreen() - when creating bitmap",exception);
            }
        }
        long t3 = SystemClock.uptimeMillis();
        Log.d("ScreenGrabber","acquireLatestImage duration" + (t2-t1) +"  copy buffer" + (t3-t2));
